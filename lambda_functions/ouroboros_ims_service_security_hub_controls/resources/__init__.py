...
class Resource(object):
    ...
    def __init__(self, resourceId=None, *args, **kwargs):
        ...
        self._props = {}
        if self.resourceId:
            self._from_ddb(resourceId=self.resourceId)
    ...
    def Response(self,handlerResponse):
        ...
        _resp["body"] = json.dumps(_resp_body_json,cls=ComplexEncoder)
    ...
    def api_update(self, event:dict,**kwargs):
        resourceId = event["resources"][self.pk]
        obj = event["payload"]
        resp = self.update(resourceId=resourceId,obj=obj)
        return resp
